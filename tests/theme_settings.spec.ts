...
describe('Module: theme settings validation (config/settings_schema.json)', () => {
  ...
  describe('Unit: Settings', () => {
    ...
    // Couldn't figure out an elegant way to set additionalProperties: false. Skipping for now.
    it.skip('refuses the label property on color_scheme_group settings', async () => {
      const settings = `
        [{
